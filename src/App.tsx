  ...
  return (
    <HashRouter >
        <Routes>
            ...
            <Route path={ ServicePageData.link } element={<ServicesPage serviceProps={ServicePageData} />} />
            { ServicePageData.items.map( service => {
                return <Route key={service.title} path={ service.link } element={<ServicesPage serviceProps={service} />} />
            })}

            <Route path={ '/team' } element={<TeamPage bios={TeamBiosData} />} />
            { TeamBiosData.map(bio => {
                return <Route key={bio.title} path={ bio.link } element={<TeamBioPage {...bio} />} />
            })}
