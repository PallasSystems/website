...
export const AgileSVG: FC<ImageProperty> = ({id, className, height, width}) => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
        ...
        viewBox="-60 -100 590 590" fill="currentColor">
        <title>Agile</title>
...
export const FailFastSVG: FC<ImageProperty> = ({id, className, height, width}) => {
  return (
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
          id={ id }
          width={ undefined === width || null === width ? "140" : width }
          height={ undefined === height || null === height ? "140"  : height }
          className={ undefined === className || null === className ? ""  : className }
          viewBox="-10 0 75 65" fill="currentColor">
...
export const KanbanSVG: FC<ImageProperty> = ({id, className, height, width}) => {
  return (
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
          id={ id }
          width={ undefined === width || null === width ? "140" : width }
  ...
  export const MVPSVG: FC<ImageProperty> = ({id, className, height, width}) => {
    return (
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
          ...
          <path d="M44 14 24 4 4 14v20l20 10 20-10V14Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" fillOpacity=".01"/>
          <path d="m4 14 20 10M24 44V24M44 14 24 24M34 9 14 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>);
  }

  export const ScrumSVG: FC<ImageProperty> = ({id, className, height, width}) => {
    return (
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
          id={ id }
          width={ undefined === width || null === width ? "140" : width }
          height={ undefined === height || null === height ? "140"  : height }
          className={ undefined === className || null === className ? ""  : className }
          viewBox="0 0 380 380" fill="currentColor">
