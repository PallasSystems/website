...
export const ServiceScrumData: ServiceDetailProperties = {
  ...
  img: { id: 'Container.Description.Row.Col.Img', height: '9rem', width: '9rem' },
  description: [
    'Scrum allows us to regularly track the progress of delivery and helps to maintain focus on your vision',
  ],
};
...
export const ServiceAgileData: ServiceDetailProperties = {
  ...
  link: '/services/agile',
  img: { id: 'Container.Description.Row.Col.Img', src: agileSVG },
  description: [
