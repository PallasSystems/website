...
export const AssessSVG: FC<ImageProperty> = ({id, className, height, width}) => {
  return (
...
export const CloudSVG: FC<ImageProperty> = ({id, className, height, width}) => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
          id={ undefined === id || null === id ? "svg" : id }
          width={ undefined === width || null === width ? "140" : width }
...
export const SupportSVG: FC<ImageProperty> = ({id, className, height, width}) => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" 
          id={ undefined === id || null === id ? "svg" : id }
          width={ undefined === width || null === width ? "140" : width }
