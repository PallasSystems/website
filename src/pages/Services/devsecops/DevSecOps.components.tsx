...
export const DevSecOpsSVG: FC<ImageProperty> = ({
  id,
  className,
  height,
  width,
...
export const ContinuousDeploymentSVG: FC<ImageProperty> = ({
  id,
  className,
  height,
  width,
...
export const ContinuousIntegrationSVG: FC<ImageProperty> = ({
  id,
  className,
  height,
  width,
...
export const TestingSVG: FC<ImageProperty> = ({
  id,
  className,
  height,
  width,
